...
?>
	<section class="isothermal">
		<div class="wrapper">
			<h1 class="title">Оси для полуприцепов "ТОНАР"</h1>
			<ul class="isothermal-list">
				<li class="isothermal-item">
					<a href="#">
						...
						<img src="img/osi/firstPicture.png" alt="">
					</a>
				</li>
				<li class="isothermal-item">
					<a href="#">
						...
						<img src="img/osi/secondPicture.png" alt="">
					</a>
				</li>
				<li class="isothermal-item">
					<a href="#">
						<h2 class="trailer-name">
							Оси с рессорной подвеской
						</h2>
						<img src="img/osi/thirdPicturepng.png" alt="">
					</a>
				</li>
				<li class="isothermal-item">
					<a href="#">
						...
						<img src="img/osi/fourthPicture.png" alt="">
					</a>
				</li>
			</ul>
		</div>
