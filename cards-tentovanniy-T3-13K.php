	...
	<section class="izotermicheskiy_r4_16">
		<div class="wrapper">
			<div class="izotermicheskiy_r4_16-description">
				...
				<p class="subtitle">
					Полуприцеп Тонар T3-13/K предназначен для перевозки грузов массой до 27 000 килограммов, при этом
					объем кузова равен 92 кубическим метрам. Особое внимания заслуживает тентовая ткань, обладающая
					плотностью, равной 900 граммов на квадратный метр. Данный полуприцеп шторно-бортовой (крыша и бока
					полуприцепа сдвигаются отдельно), что очень удобно при погрузке-разгрузке как с боков полуприцепа,
					так и с верхней части. Для большего комфорта эксплуатации, с наружной стороны имеется специальная
					ручка предназначенная для сдвигания бокового тента.
				</p>
				<p class="subtitle">
					Конструкция кузова отличается повышенной прочностью, поскольку борта данной модели изготавливаются
					из алюминия. Приобретая такой полуприцеп Вы получаете ряд преимуществ, ведь алюминий обладает
					повышенной стойкостью к коррозии и различным воздействиям внешней среды. Все наши полуприцепы
					оснащаются краном управления пневмоподвеской, позволяющим регулировать высоту для более комфортной
					погрузки и разгрузки. Купить полуприцеп Тонар этой, либо другой модели, а также получить подробную
					консультацию специалиста при возникновении каких-либо вопросов, можно на нашем сайте.
				...
				<div class="parametrs-list">
					...
					<ul class="equipment">
						...
						<li class="equipment-item">
							<b>Тип</b>
							<span class="point"></span>
							<span class="description-model">шторный полуприцеп</span>
						</li>
						<li class="equipment-item">
							<b>Кузов</b>
							<span class="point"></span>
							<span class="description-model">со сдвижной крышей и сдвижными боковинами; <br> с элементами
								крепления груза.</span>
						</li>
						<li class="equipment-item">
							<b>Кол-во осей</b>
							<span class="point"></span>
						...
						<li class="equipment-item">
							<b>Тип ошиновки</b>
							<span class="point"></span>
							<span class="description-model">односкатный</span>
						</li>
						<li class="equipment-item">
							<b>Подвеска</b>
							<span class="point"></span>
					...
					<ul class="sizes">
						...
						<li class="sizes-item">
							...
							<span class="point"></span>
							<span class="description-model">2 480</span>
						</li>
						<li class="sizes-item">
					...
					<ul class="axes">
						...
						<li class="axes-item">
							...
							<span class="point"></span>
							<span class="description-model">27 000</span>
						</li>
					</ul>
					<h4> Оси "Тонар":</h4>
					<ul class="axes">
						...
						<li class="axes-item">
							<b>Подвеска</b>
							<span class="point"></span>
							<span class="description-model">зависимая, на <br>продольных упругих рычагах с
								пневматическими упругими <br>элементами и телескопическими гидравлическими
								<br>амортизаторами</span>
						</li>
						<li class="axes-item">
							<b>Подъёмная ось</b>
							<span class="point"></span>
					...
					<ul class="other_parametrs">
						<li class="other_parametrs-item">
							<b>Задняя стенка</b>
							<span class="point"></span>
							<span class="description-model">оборудована распашной двустворчатой алюминиевой <br> дверью;
								на каждой двери по 2 <br> запорных устройства</span>

						<li class="other_parametrs-item">
							<b>Крыша</b>
							<span class="point"></span>
							<span class="description-model">сдвижная крыша с возможностью <br> верхней загрузки</span>
						</li>
						<li class="other_parametrs-item">
							<b>Боковые стенки / борта</b>
							<span class="point"></span>
							<span class="description-model">шторного типа / алюминиевые, 8 шт</span>
						</li>
						<li class="other_parametrs-item">
							<b>Пол</b>
							<span class="point"></span>
