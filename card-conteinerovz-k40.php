...
?>
	<section class="picture-box">
		<img src="img/conteinerovozi/k4-40-thirdpicture.png" alt="">
	</section>

	<section class="izotermicheskiy_r4_16">
		<div class="wrapper">
			<div class="izotermicheskiy_r4_16-description">
				<h2>Полуприцеп-контейнеровоз Тонар К4-40</h2>
				...
				<div class="parametrs-list">
					...
					<ul class="equipment">
						<li class="equipment-item">
							...
							<span class="description-model">9989</span>
						<li class="equipment-item">
							<b>ССУ</b>
							<span class="point"></span>
							<span class="description-model">1 100 / 1 150</span>
						</li>
						<li class="equipment-item">
							<b>Тип</b>
							<span class="point"></span>
							<span class="description-model">полуприцеп-контенеровоз</span>
						</li>
						<li class="equipment-item">
							<b>Кол-во осей</b>
							<span class="point"></span>
					...
					<ul class="sizes">
						<li class="sizes-item">
							...
							<span class="point"></span>
							<span class="description-model">12 465</span>
						</li>
						<li class="sizes-item">
							<b>Ширина полуприцепа, мм</b>
							<span class="point"></span>
					...
					<ul class="weight">
						<li class="weight-item">
							...
							<span class="description-model">5 500</span>
						</li>
						<li class="weight-item">
							<b>Масса перевозимого груза (технически допустимая), кг</b>
							<span class="point"></span>
							<span class="description-model"></span>38 100
						</li>
						<li class="weight-item">
							<b>Нагрузка на ССУ, кг</b>
							<span class="point"></span>
							<span class="description-model">11 380</span>
						</li>
						<li class="weight-item">
							<b>Осевая нагрузка, кг</b>
							<span class="point"></span>
							<span class="description-model">32 000</span>
						</li>
					</ul>
					<h4> Оси "Тонар":</h4>
					<ul class="axes">
						...
						<li class="axes-item">
							<b>Подъёмная ось</b>
							<span class="point"></span>
							<span class="description-model">1 и 2 или 1 и 4</span>
						</li>
					</ul>
					<h4>Остальные характеристики</h4>
					<ul class="other_parametrs">
						<li class="other_parametrs-item">
							<b>Типы перевозимых контейнеров</b>
							<span class="point"></span>
							<span class="description-model">1АА, 1А, 1АХ</span>
					...
					<p class="pricing">Цена: 1 780 000 руб.</p>
				</div>
			</div>
		</div>
	</section>
