...
?>
	...
	<section class="picture-box">
		<img src="img/conteinerovozi/k-4-20-secondpicture.png" alt="">
	</section>

	<section class="izotermicheskiy_r4_16">
		<div class="wrapper">
			<div class="izotermicheskiy_r4_16-description">
				<h2>Полуприцеп-контейнеровоз Тонар К4-20</h2>
				...
				<div class="parametrs-list">
					...
					<ul class="equipment">
						<li class="equipment-item">
							...
							<span class="description-model">9988</span>
						<li class="equipment-item">
							<b>ССУ</b>
							<span class="point"></span>
					...
					<ul class="sizes">
						<li class="sizes-item">
							...
							<span class="point"></span>
							<span class="description-model">9 485</span>
						</li>
						<li class="sizes-item">
						...
						<li class="sizes-item">
							<b>Высота, мм</b>
							<span class="point"></span>
							<span class="description-model">1 305</span>
						</li>
						<li class="sizes-item">
					...
					<ul class="weight">
						<li class="weight-item">
							...
							<span class="description-model">5 400</span>
						</li>
						<li class="weight-item">
							<b>Масса перевозимого груза, кг</b>
							<span class="point"></span>
							<span class="description-model"></span>30 600
						</li>
						<li class="weight-item">
							<b>Нагрузка на ССУ, кг</b>
							<span class="point"></span>
							<span class="description-model">10 000</span>
						</li>
						<li class="weight-item">
							<b>Осевая нагрузка, кг</b>
							<span class="point"></span>
							<span class="description-model">26 000</span>
						</li>
					</ul>
					<h4> Оси "Тонар":</h4>
					<ul class="axes">
						...
						<li class="axes-item">
							<b>Подъёмная ось</b>
							<span class="point"></span>
							<span class="description-model">передняя (принудительноподъёмная) и 2 <br> или 4
								(автоматические)</span>
						</li>
					</ul>
					...
					<ul class="other_parametrs">
						<li class="other_parametrs-item">
							...
							<span class="point"></span>
							<span class="description-model">1CC, 1C, 1CX</span>
