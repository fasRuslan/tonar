					...
					<div class="parametrs-list">
						...
						<ul class="equipment">
							...
							<li class="equipment-item">
									<b>Тип</b>
									<span class="point"></span>
									<span class="description-model">Полуприцеп - скотовоз</span>
							</li>
							<li class="equipment-item">
									<b>Кузов</b>
									<span class="point"></span>
						...
						<ul class="other_parametrs">
							...
							<li class="other_parametrs-item">
									...
									<span class="point"></span>
									<span class="description-model">выполнены из алюминия,  могут полностью <br>открываться и закрываться,<br> ручное управление</span>
							</li>
							<li class="other_parametrs-item">
									<b>Электрооборудование</b>
									<span class="point"></span>
							...
							<li class="other_parametrs-item">
									<b>Устройства слива</b>
									<span class="point"></span>
									<span class="description-model">2 патрубка в задней части полуприцепа</span>
							</li>
							<li class="other_parametrs-item">
									<b>Система поения</b>
									<span class="point"></span>
